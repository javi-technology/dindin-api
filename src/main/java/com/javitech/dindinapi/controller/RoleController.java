...
public class RoleController {
    ...
    public ResponseEntity<HashMap<String, Object>> findAll() {
        return ResponseEntity.status(HttpStatus.OK).body(
            httpService.createResponse("Roles retrieved successfully.", roleService.findAll())
        );
    }
    ...
    public ResponseEntity<HashMap<String, Object>> findById(@PathVariable UUID id) {
        ...
        if (role.isEmpty()) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(
                httpService.createResponse("Role with ID " + id + " does not exist.", null)
            );
        }
        return ResponseEntity.status(HttpStatus.OK).body(
            httpService.createResponse("Role retrieved successfully.", role.get())
        );
    }
    ...
    public ResponseEntity<HashMap<String, Object>> create(@RequestBody Role role) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(
            httpService.createResponse("Role created successfully.", roleCreated)
        );
    }
    ...
    public ResponseEntity<HashMap<String, Object>> update(@RequestBody Role role) {
        ...
        return ResponseEntity.status(HttpStatus.OK).body(
            httpService.createResponse("Role updated successfully.", roleUpdated)
        );
    }
    ...
    public ResponseEntity<?> delete(@PathVariable UUID id) {
        ...
        return ResponseEntity.status(HttpStatus.OK).body(
            httpService.createResponse("Role deleted successfully.", null)
        );
    }
}
